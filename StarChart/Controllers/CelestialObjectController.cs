...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public IActionResult Update(int id, CelestialObject stars)
        {
            var celestialObject = _context.CelestialObjects.Find(id);
            if (celestialObject == null)
                return NotFound();
            celestialObject.Name = stars.Name;
            celestialObject.OrbitalPeriod = stars.OrbitalPeriod;
            celestialObject.OrbitedObjectId = stars.OrbitedObjectId;
